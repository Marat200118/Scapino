...
#define RST_PIN_1 8  // Reset pin for the first RFID reader
#define RST_PIN_2 9  // Reset pin for the second RFID reader
#define CS_PIN_1 10  // Chip Select (SDA) pin for the first RFID reader
#define CS_PIN_2 6   // Chip Select (SDA) pin for the second RFID reader
